...
plugins {
    ...
    // Applied without a version: the embedded Flutter module already puts the Kotlin
    // Gradle plugin on the build classpath. Upstream instead relies on AGP 9.3's built-in
    // Kotlin, which this fork cannot enable (it breaks Flutter's pub packages).
