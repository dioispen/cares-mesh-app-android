...
plugins {
    ...
    // See app/build.gradle.kts: applied without a version because the embedded Flutter
    // module already puts the Kotlin Gradle plugin on the build classpath.
...
val sharedSourceIncludes = listOf(
    ...
    // Pure-Kotlin geohash codec; HealthReportPayload (protocol/) degrades coordinates with it.
    "com/bitchat/android/geohash/Geohash.kt",
